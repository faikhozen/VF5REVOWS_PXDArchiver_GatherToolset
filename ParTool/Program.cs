    ...
    internal static partial class Program
    {
        private static void Main(string[] args)
        {
            ...
            parserResult
                ...
                .WithParsed<Options.GatherCompile>(GatherCompile)
                .WithNotParsed(x =>
                {
                    if (args.Length == 1)
                    {
                        ...
                        {
                            Console.WriteLine($"PAR file detected: '{args[0]}'");
                            Console.Write("Choose operation: (E)xtract PAR  or  (C)ompile mods into PAR? [e/C]: ");
                            ...
                            else
                            {
                                ...
                                {
                                    InputParArchivePath = args[0],
                                    ModsDirectory = "mods",
                                    OutputParArchivePath = "output/chara.par",
                                    Compression = 0,
                                };
